...
function QuoteCard() {
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#120838] via-[#1A0933] to-[#0A0D2A] text-white p-6 sm:p-8 md:p-10 shadow-[0_20px_50px_rgba(26,5,162,0.3)] border border-[#E60067]/30 transition-all duration-500">
        ...
        <div className="pointer-events-none absolute top-6 right-8 opacity-20 hidden sm:block">
          <div className="grid grid-cols-5 gap-2">
            {Array.from({ length: 15 }).map((_, i) => (
              <span key={i} className="size-1 rounded-full bg-[#E60067]" />
            ))}
          </div>
        </div>
        ...
        <div className="flex justify-center relative z-10 mb-4">
          <motion.span
            ...
            className="inline-flex items-center gap-2 rounded-full border border-[#E60067]/40 bg-[#E60067]/15 px-4 py-1.5 text-xs font-extrabold text-[#FF66B2] shadow-inner backdrop-blur-md"
          >
        ...
        <div className="relative z-10 mb-4 flex justify-center">
          <motion.div
            ...
            className="grid size-12 sm:size-14 place-items-center rounded-2xl bg-gradient-to-br from-[#E60067] to-[#1A05A2] p-3 text-white shadow-[0_8px_20px_rgba(230,0,103,0.5)] border border-white/20"
          >
        ...
        <div className="relative z-10 flex items-center justify-center gap-3 my-4">
          <div className="h-[1px] w-12 bg-gradient-to-r from-transparent via-[#E60067] to-transparent" />
        ...
        <div className="relative z-10 mt-8 grid grid-cols-1 sm:grid-cols-3 gap-3 max-w-2xl mx-auto">
          <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-md p-3 text-center transition-all hover:bg-white/10 hover:border-[#E60067]/40">
        ...
        <AnimatePresence>
          {isExpanded && (
            ...
            >
              <div className="rounded-2xl bg-white/10 border border-[#E60067]/20 p-5 sm:p-6 backdrop-blur-sm text-center shadow-inner">
        ...
        <div className="relative z-10 mt-8 flex justify-center">
          <button
            ...
            className="group relative inline-flex items-center gap-2 overflow-hidden rounded-full bg-gradient-to-r from-[#E60067] via-[#D0005D] to-[#1A05A2] px-6 py-3 text-xs sm:text-sm font-black text-white shadow-[0_8px_20px_rgba(230,0,103,0.4)] transition-all duration-300 hover:scale-105 hover:shadow-[0_12px_25px_rgba(230,0,103,0.6)] cursor-pointer"
          >
